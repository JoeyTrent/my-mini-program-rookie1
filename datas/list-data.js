let list_data = [
  
  {
    ...
    date: 'may 19 2018',
    title: 'joey',
    detail_img: '/images/detail/carousel/hmbb1.jpg',
    avatar: '/images/avatar/4.png',
    detail_content: '柏拉图和老师苏格拉底，学生亚里士多德并称为希腊三贤。他创造或发展的概念包括：柏拉图思想、柏拉图主义、柏拉图式爱情等。柏拉图的主要作品为对话录，其中绝大部分都有苏格拉底出场。但学术界普遍认为，其中的苏格拉底形象并不完全是历史上真实存在的苏格拉底。',
    headImgSrc: '/images/detail/carousel/hmbb1.jpg',
    author: '钢铁侠 ',
    dataTime: '24time',
    ...
    detail: '钢铁战队。。',
    music: {
      //http://music.163.com/song/media/outer/url?id=4304749.mp3 
      dataUrl: 'http://music.163.com/song/media/outer/url?id=29753560.mp3', // 音乐链接
      title: 'eye of the tiger',   // 音乐标题
  ...
  },
  {
    ...
    date: 'may 19 2018',
    title: 'joey',
    detail_img: '/images/detail/carousel/hmbb2.jpg',
    avatar: '/images/avatar/4.png',
    detail_content: '柏拉图和老师苏格拉底，学生亚里士多德并称为希腊三贤。他创造或发展的概念包括：柏拉图思想、柏拉图主义、柏拉图式爱情等。柏拉图的主要作品为对话录，其中绝大部分都有苏格拉底出场。但学术界普遍认为，其中的苏格拉底形象并不完全是历史上真实存在的苏格拉底。',
    headImgSrc: '/images/detail/carousel/hmbb2.jpg',
    author: '美国队长',
    dataTime: '24time',
    detail_love_image1: '/images/icon/chat.png',
    detail_love_image2: '/images/icon/view.png',
    ...
    detail: '有魅力的老男人。',
    music: {
      dataUrl: 'http://music.163.com/song/media/outer/url?id=4304749.mp3 ', // 音乐链接
      title: 'The Goofy Goober Song',    // 音乐标题
      coverImgUrl: 'http://y.gtimg.cn/music/photo_new/T002R300x300M000003rsKF44GyaSk.jpg?max_age=2592000',
    },
    postId: 1
  },
  {
    ...
    date: 'may 19 2018',
    title: 'joey',
    detail_img: '/images/detail/carousel/hmbb3.jpg',
    avatar: '/images/avatar/4.png',
    detail_content: '柏拉图和老师苏格拉底，学生亚里士多德并称为希腊三贤。他创造或发展的概念包括：柏拉图思想、柏拉图主义、柏拉图式爱情等。柏拉图的主要作品为对话录，其中绝大部分都有苏格拉底出场。但学术界普遍认为，其中的苏格拉底形象并不完全是历史上真实存在的苏格拉底。',
    headImgSrc: '/images/detail/carousel/hmbb3.jpg',
    author: '绿巨人',
    dataTime: '24time',
    detail_love_image1: '/images/icon/chat.png',
    detail_love_image2: '/images/icon/view.png',
    ...
    detail: '巨无霸教授。',
    music: { 
      dataUrl: 'http://music.163.com/song/media/outer/url?id=409872276.mp3', // 音乐链接
      title: 'free stuff',   // 音乐标题
      coverImgUrl: 'http://y.gtimg.cn/music/photo_new/T002R300x300M000003rsKF44GyaSk.jpg?max_age=2592000',
    },
    postId: 2
  },
